...
object Constants {
    ...
    const val DEFAULT_PROFILE_PICTURE_PATH = "${BASE_URL}profile_pictures/defaultavatar.webp"
    const val DEFAULT_BANNER_IMAGE_PATH = "${BASE_URL}profile_pictures/defaultbannerimage.jpg"
}